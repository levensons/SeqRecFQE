...
def get_ds(
    ...
    if ds_name == "zvuk_danil":
        train = read_and_rename("../sasrec_zvuk/training_temp.csv", use_csv=True)
        test = read_and_rename("../sasrec_zvuk/testset.csv", use_csv=True)
        holdout = read_and_rename("../sasrec_zvuk/holdout_valid_temp_cut.csv", use_csv=True)
